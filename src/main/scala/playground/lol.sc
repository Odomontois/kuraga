...
val pred: Nat => Nat = x => fst[Nat, Nat](x[Tuple[Nat, Nat]](tuple(zero)(zero))(t => tuple(snd[Nat, Nat](t))(succ(snd[Nat, Nat](t)))))
val predO: Nat => Opt[Nat] = x => fst[Opt[Nat], Nat](x[Tuple[Opt[Nat], Nat]](tuple(inl[Un, Nat](unit))(zero))(t => tuple(inr[Un, Nat](snd[Opt[Nat], Nat](t)))(succ(snd[Opt[Nat], Nat](t)))))
