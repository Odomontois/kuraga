...
object DropRed:
  def dropRedCats[P[-i, o]](cats: Layer[P])(using P: Constant[P], pc: Lens2[P, Cat]): Layer[P] =
  ...
  extension (catDogs: Layer[CatOrDogs])
    def toCatDogVector: CatDogVector =
  ...
  val x =
    Cat("lilly", "red", Cat("anya", "red", Cat("boris", "black", Dog("mashka", 3, Cat("manya", "red", End)))))
